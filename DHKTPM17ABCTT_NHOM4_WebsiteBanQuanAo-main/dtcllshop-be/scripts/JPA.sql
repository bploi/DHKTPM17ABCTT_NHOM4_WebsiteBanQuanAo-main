-- 1️⃣ Drop database cũ và tạo mới
DROP DATABASE IF EXISTS dtcllshop;
CREATE DATABASE dtcllshop CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE dtcllshop;
...
-- 15️⃣ Bảng wishlist_detail
CREATE TABLE wishlist_detail (
    wishlist_detail_id INT AUTO_INCREMENT PRIMARY KEY,
    note VARCHAR(255),
    created_at DATETIME,
    wishlist_id INT,
    product_id INT,
...
VALUES
('Top', 'Các loại áo như áo thun, sơ mi, hoodie...', 'https://i.postimg.cc/ncVMTKvS/Top.jpg', 1, true, '2025-11-10', '2025-11-10'),
('Bottom', 'Các loại quần như jeans, trousers, shorts...', 'https://i.postimg.cc/tTH46FqJ/Bottom.jpg', 2, true, '2025-11-10', '2025-11-10'),
('Accessories', 'Các loại phụ kiện như ví, mũ, thắt lưng...', 'https://i.postimg.cc/L4D8qqr8/Accessories.jpg', 3, true, '2025-11-10', '2025-11-10');
